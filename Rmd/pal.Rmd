...
-   Switch to the more powerful [`waldo::compare()`](https://github.com/r-lib/waldo) which i.a. RStudio's Romain François [recommends to
    use](https://github.com/tidyverse/dplyr/pull/5565#issuecomment-737750802): To provide `ignore_col_order` and `ignore_row_order` functionality, sort `x` and
    `y` before feeding it to `waldo::compare()`.
