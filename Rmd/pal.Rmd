...
-   Switch to [`tombi` CLI](https://tombi-toml.github.io/tombi/docs/cli)! Note that is has a different [config
...
TODO: Submit this function as `check_criterion()` upstream as outlined [from here on](https://github.com/r-lib/rprojroot/pull/83#issuecomment-1874876315).
