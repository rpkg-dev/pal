...
-   [x] Make PR proposing to extend `desc::desc_get_field()`'s `trim_ws` param to normalize whitespaces within the queried value. *See
    [\#101](https://github.com/r-lib/desc/pull/101)!*
