...
#'
#' @param xml_nodes The Markdown parse tree. An [`xml_node`][xml2::xml_node-class] or [`xml_nodeset`][xml2::xml_nodeset-class].
#'
#' @return A list.
#' @family commonmark
#' @export
...
#'   pal::md_xml() |>
#'   pal::md_xml_i_tree()
md_xml_i_tree <- function(xml_nodes) {
...
Extending the [gh](https://gh.r-lib.org/) package, leveraging [GitHub's v4 GraphQL API](https://docs.github.com/en/graphql).
