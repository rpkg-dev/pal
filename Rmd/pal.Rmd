...
build_readme <- function(input = "README.Rmd",
  ...
  cli_process_expr(
    ...
    expr = {
      ...
      rmarkdown::render(input = checkmate::assert_file(input,
                                                       access = "r"),
...
#' Assemble an (R) comment string of the desired line width
#'
#' Takes a vector of text lines, wraps them at the specified line width, prefixes them with comment markers and returns the result as a single string.
#'
