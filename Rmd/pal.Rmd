...
Note that the colors defined here are intended for terminals capable to display a [ANSI 24-bit colors](https://en.wikipedia.org/wiki/ANSI_escape_code#24-bit).
