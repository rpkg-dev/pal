...
-   Internally we rely on a modified version of `dplyr:::is_equal_data_frame()`, exposing the `name_repair` argument. It can be retired if [this
    PR](https://github.com/tidyverse/dplyr/pull/5565) gets merged upstream.

-   Switch to the more powerful [`waldo::compare()`](https://github.com/r-lib/waldo) which i.a. RStudio's Romain François [recommends to use
    it](https://github.com/tidyverse/dplyr/pull/5565#issuecomment-737750802) **as soon as there's a way to [ignore row/column
    ordering](https://github.com/tidyverse/dplyr/pull/5565#issuecomment-737883493)**
...
-   There will probably be a better dplyr API introduced for this in the future, see [issue \#4770](https://github.com/tidyverse/dplyr/issues/4770).

-   The functions below are [borrowed from Lionel Henry](https://github.com/tidyverse/dplyr/issues/5536#issuecomment-701497301). All credits go to him.

-   Performance-wise, these are currently the [best known solutions](https://github.com/tidyverse/dplyr/issues/4770#issuecomment-704285294).
...
-   Remove `--atx-headers` which has been deprecated and replaced by `--markdown-headings=atx` in [Pandoc
    2.11.2](https://github.com/jgm/pandoc/releases/tag/2.11.2) (ATX headings are now the default) *as soon as the latest [RStudio stable
    release](https://rstudio.com/products/rstudio/download/) includes Pandoc 2.11.2+ (probably with the first stable release of RStudio 1.4)*
