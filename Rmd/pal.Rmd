...
-   roxygen2 only allows plaintext, optionally formatted as inline code, inside to documentation link text. But it does not allow to mix text both formatted as
    inline code and not inside documentation link text (it [throws a
