...
# `r paste0(pal::desc_value("Package"), ": ", pal::desc_value("Title"))` <a href="https://pal.rpkg.dev/"><img src="man/figures/logo.png" alt="Package Logo" class="pkg-logo" align="right" height="180"/></a>
